...
namespace archive_nus3bank
{
    ...
    {
        public NUS3TONE.NUS3ToneEntry Entry;
    }

    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct NUS3Header
    {
        public Magic magic;
    ...
    //[StructLayout(LayoutKind.Sequential, Pack = 1)]
    public class NUS3BankTocEntry
    {
        public NUS3BankTocEntry(Stream input)
        {
    ...
    public class NUS3PROP
    {
        public NUS3PROP(Stream input)
        {
    ...
    public class NUS3BINF
    {
        public NUS3BINF(Stream input)
        {
            using (var br = new BinaryReaderX(input, true))
            {
                unk1 = br.ReadInt32();
    ...
    public class NUS3TONE
    {
        public NUS3TONE(Stream input, int toneOffset, int packOffset)
        {
            using (var br = new BinaryReaderX(input, true))
            {
                toneCount = br.ReadInt32();

                toneEntries = new NUS3ToneEntry[toneCount];
                for (int i = 0; i < toneCount; i++)
                    toneEntries[i] = new NUS3ToneEntry
                    {
        ...
        public NUS3ToneEntry[] toneEntries;

        public class NUS3ToneEntry
        {
            public int offset;
            public int metaSize;
            public byte[] unk1;
