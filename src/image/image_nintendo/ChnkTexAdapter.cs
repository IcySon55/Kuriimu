    ...
    public class ChnkTexAdapter : IImageAdapter
    {
        ...
        public void Load(string filename)
        {
            ...
            if (FileInfo.Exists)
            {
                ...
                _bitmaps = _tex.Bitmaps.Select(b => new ChnkTexBitmapInfo { Bitmap = b, Format= ChnkTexFormat.BGR555, BitDepth = _tex.BitDepth, HasTX4I = _tex.HasMap }).ToList<BitmapInfo>();
            }
        }
