...
{
    [FilePluginMetadata(Name = "OBB", Description = "Generic OBB archive for Android", Extension = "*.obb", Author = "onepiecefreak", About = "This is the OBB archive manager for Karameru.")]
    ...
    public class ObbManager : IArchiveManager
    {
        ...
        public Identification Identify(Stream stream, string filename)
        {
            ...
            {
                if (br.ReadString(4) == ".OBB") return Identification.True;
            }
