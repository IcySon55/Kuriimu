...
namespace Image
{
    ...
    /// </summary>
    [Export("Common", typeof(IImageCommon))]
    public class Common : IImageCommon
    {
        ...
        /// </summary>
        static IEnumerable<Point> GetPointSequence(ImageSettings2 settings)
        {
        ...
        public Bitmap Load(byte[] bytes, ImageSettings2 settings)
        {
        ...
        public byte[] Save(Bitmap bmp, ImageSettings2 settings)
        {
            var points = GetPointSequence(settings);
