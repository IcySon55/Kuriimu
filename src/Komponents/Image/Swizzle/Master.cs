...
{
    [Export("MasterSwizzle", typeof(IImageMasterSwizzle))]
    public class MasterSwizzle : IImageMasterSwizzle
    {
        ...
        public MasterSwizzle([Import("MasterSwizzleStride")]int imageStride, [Import("MasterSwizzleInit")]Point init,
            [Import("MasterSwizzleBitField")]IEnumerable<(int, int)> bitFieldCoords, [Import("MasterSwizzleYTransform")]IEnumerable<(int, int)> initPointTransformOnY = null)
        {
